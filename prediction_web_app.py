...
def main():
    ...
    if uploaded_file is not None:
        ...
        st.audio(audio_bytes, format='audio/mp3', start_time=0, end_time=None, loop=False)
    ...
    st.sidebar.write(
        '<a class="custom-link" style="color:#888888; text-decoration:none;" href="https://github.com/sreenithiau">Sreenithi A</a>',
    ...
    st.markdown(
        ...
        <style>
        body {
            background: url("https://www.imghippo.com/i/7DI6v1714556345.webp") no-repeat center center fixed;
